          ...
          {K.NAVLINKS.map((link, idx) =>
            link.dropdown ? (
              ...
              >
                <Link
                  to={link.path}
                  className="flex items-center gap-1 hover:text-ydn-green font-medium"
                >
                  {link.name}
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    "hover:text-ydn-green font-medium",
                    isActive && "text-ydn-green"
                  )
                }
              >
                {link.name}
